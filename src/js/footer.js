...
const footerTemplate = require('../templates/footer/footer.html');
const tabTemplate = require('../templates/footer/footer-tab.html');
const viewTemplate = require('../templates/footer/footer-tab-view.html');
 ...
 */
module.exports = Backbone.View.extend(/** @lends module:js-whatever/js/footer.Footer.prototype */{
    /**
