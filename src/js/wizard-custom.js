...
const template = require('../templates/wizard/wizard.html');
 ...
 */
module.exports = Backbone.View.extend(/** @lends module:js-whatever/js/wizard-custom.WizardCustom.prototype */{
