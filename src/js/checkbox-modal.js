...
const checkboxModal = require('../templates/checkbox-modal/checkbox-modal.html');
const checkboxTable = require('../templates/checkbox-modal/checkbox-table.html');
 ...
 * });
 */
module.exports = Backbone.View.extend(/** @lends module:js-whatever/js/checkbox-modal.CheckboxModal.prototype */{
